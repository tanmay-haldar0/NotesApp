...
const SearchBar = ({ value, onChange, handleSearch, onClearSearch }) => {
  return (
    <div className='w-full max-w-[280px] sm:max-w-[320px] flex items-center px-4 bg-slate-100 rounded-md'>
      <input
        type="text"
        placeholder='Search Notes'
        className='w-full texr-xs bg-transparent py-[11px] outline-none'
        value={value}
        onChange={onChange}
      />
